import { ITunesPodcastDetailQueryExtended, ITunesPodcastKind } from '../models';

export const podcastDetailMock: ITunesPodcastDetailQueryExtended = {
  resultCount: 3,
  results: [
    {
      wrapperType: 'track',
      kind: ITunesPodcastKind.podcast,
      artistId: 1535844019,
    ...
    },
    {
      ...
      collectionId: 1535809341,
      collectionName: 'The Joe Budden Podcast',
      kind: ITunesPodcastKind['podcast-episode'],
